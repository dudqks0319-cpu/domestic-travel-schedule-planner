...
v1Routes.get("/trips", requireAuth, (c) => notImplemented(c, "여행 목록"));
v1Routes.post("/trips", requireAuth, (c) => notImplemented(c, "여행 생성"));
v1Routes.get("/trips/:tripId", requireAuth, (c) => notImplemented(c, "여행 상세"));
v1Routes.patch("/trips/:tripId", requireAuth, (c) => notImplemented(c, "여행 수정"));
v1Routes.delete("/trips/:tripId", requireAuth, (c) => notImplemented(c, "여행 삭제"));
...
v1Routes.post("/trips/:tripId/share", requireAuth, (c) => notImplemented(c, "공유 링크 생성"));

v1Routes.get("/share/:shareId", (c) => notImplemented(c, "공유 링크 조회"));
